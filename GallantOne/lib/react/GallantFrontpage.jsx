...
var GallantFrontpage = React.createClass({
            ...
            <div>
                ...
                <div id="goBoxes">
                    <div className="descBox">
                        <div className="gSubHeader"><img src="/images/one/flange.png"/>Digital Artistry</div>
                        <div className="line_540"></div>
                    ...
                    <div className="aboutBox">
                        <div className="gSubHeader"><img src="/images/one/flange.png"/>The Architect</div>
                        <div className="line_240"></div>
                        <p>
                        <strong>Greg A. Gallant</strong> is a professional technologist and software engineer and web designer with over 14 years of experience working in New York City.  
                        <br/> <br/>
