...
var ScreenHeader = React.createClass({displayName: 'ScreenHeader',
    render: function() {
        var renderThis = React.createElement("div", null, React.createElement("strong", null, "Screen Header"));
        return(renderThis);
...
React.render(React.createElement(ScreenMain, null), document.getElementById('pagewrap'), callbackTest); // interesting...
