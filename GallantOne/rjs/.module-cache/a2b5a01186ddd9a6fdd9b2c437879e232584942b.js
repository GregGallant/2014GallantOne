...
var ScreenRow = React.createClass({displayName: 'ScreenRow',
    ...
    render: function() {
        ...
        var image = this.props.portfolio.image;
...
*/
        ...
        return(
                    ...
                    React.createElement("div", null, 
                        React.createElement("h6", null, React.createElement("small", null, id, " - ", client_name), 
                            React.createElement("a", {href: "{url}"}, 
                                React.createElement("img", {src: "/images/clients/{image}"})
                            )
                        ), 
...
React.renderComponent(React.createElement(ScreenMain, {portfolio: PORTFOLIO}), document.body); // interesting...
